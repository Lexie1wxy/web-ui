...
class TestSupervisionLogin:
    ...
    @pytest.mark.parametrize('username, password, assertion, assertype', read_pytestdata(__file__, 'test_supervision_login_success'))  # 测试数据
    def test_supervision_login_success(self, goDriver, username, password, assertion, assertype):
        ...
        with allure.step('点击登录'):
            ...
            login_page.sleep(3)
            login_page.get_web_title(assertion, assertype)